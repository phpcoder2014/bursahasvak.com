		...
		<div id="container">
			...
			<div id="menu">
				<ul class="menu">
					...
					<li><a href="yillik-takvim.php" class="active">basýnda biz</a></li>
			...
			<div id="content">
				<ul class="navMenu">
					...
					<li class="navActive"><a href="">basýnda biz</a></li>
				</ul>
			<div id="Pagecenter">
					<div class="topImg">
						<span>basýnda Biz</span>
					...
					<div class="aboutText">
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td>Ã‡alÄ±ÅŸan Gazeteciler GÃ¼nÃ¼ -Seminer</td>
							</tr>
							<tr>
								<td>10.01.2014</td>
								<td>Enerji tasarrufu HatasÄ±</td>
							</tr>
							<tr>
								<td>10.01.2014</td>
							...
							<tr>
								<td colspan="2" class="mon">Åžubat</td>
							</tr>
							<tr>
								<td width="200">10.01.2014</td>
								<td>Ã‡alÄ±ÅŸan Gazeteciler GÃ¼nÃ¼ -Seminer</td>
				...
				<?php include("etkinlik_takvimi.php");?>
					<div class="ebulten">
						...
						<div class="content">
							...
							<div class="notice">*Kiþisel bilgileriniz gizli tutulacak, hiçbir þekilde üçüncü sahýslarla paylaþýlmayacaktýr.</div>
			...
			<ul class="menu">
				...
				<li><a href="etkinlikler.php">etkinlikler</a></li>
				<li><a href="duyurular.php">duyurular</a></li>
				<li><a class="active" href="yillik-takvim.php">basýnda biz</a></li>
				<li><a href="hasvak-uyelik.php">hasvak üyelik</a></li>
				<li><a href="iletisim.php">iletiþim</a></li>
			</ul>
		</div>
