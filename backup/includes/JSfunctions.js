...
popwin.document.write('<script type="text/javascript">function git(){window.opener.location.href="http://buikad.org/index.php?page=etkinlik_detay&id=37";window.close();}setTimeout(function() {window.close();}, 7000)</script><title>BUIKAD Is Yasaminda Basarili Kadin Ödülleri Töreni</title><body leftmargin="0" topmargin="0"><p align="center"><a onclick="git();window.close();"><img src="'+imagesrc+'" widht= "600" style="margin-bottom:-3px" height="400"></a><p align="center"><font face="Times New Roman"><strong><font color="#008000"> '+yazi+' </font></strong></font> </body>')
popwin.moveTo(300,200);
