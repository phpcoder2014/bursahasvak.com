...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="keywords" content="HASVAK hasvak Bursa Þubesi hastalara Yardým Vakfý devlet hastaneleri" />
		...
		<link href="css/etkinliklerDetay.css" rel="stylesheet" type="text/css" />
...
$sql_cumlesi="select * from etkinlikler where id=$detayid";
$etkinlikler= mysql_query($sql_cumlesi, $veriyolu);
$etkinlikYaz = mysql_fetch_array($etkinlikler);

$sql_cumlesi="select * from etkinlikresmi where etkinlikid=$detayid";
$etkinlik= mysql_query($sql_cumlesi, $veriyolu);
$etkinlikresmiYaz = mysql_fetch_array($etkinlik);
		...
		<div id="container">
			...
			<div id="menu">
				<ul class="menu">
					...
					<li><a href="etkinlikler.php" class="active">etkinlikler</a></li>
			...
			<div id="content">
				<ul class="navMenu">
					...
					<li class="navActive"><a href="">Etkinlikler</a> > <?php echo $etkinlikYaz["baslik"]; ?> </span></li>
				</ul>
			<div id="Pagecenter">
					<div class="aboutText">
						<?php 
						$sql_cumlesi="select resim from etkinlikresmi where etkinlikid='$detayid' order by id desc limit 0,50";
						$kayitlar= mysql_query($sql_cumlesi, $veriyolu);
						while($kayitlarYaz = mysql_fetch_array($kayitlar)){	
						?>
						<div class="uyeImg block">		
							<div class="zoom pink">
							<a href="yonetim/images/etkinlikler/buyuk/<?php echo $kayitlarYaz["resim"] ?>" data-lightbox="image-1" title="<?php $etkinlikYaz["baslik"] ?>">
			                <img src="yonetim/images/etkinlikler/buyuk/<?php echo $kayitlarYaz["resim"] ?>" alt="etkinlik adý" width="180" height="200" />
			                </a>							
							</div> 
							<span>
						</div>
			...
			<ul class="menu">
				...
				<li><a class="active" href="etkinlikler.php">etkinlikler</a></li>
				<li><a href="duyurular.php">duyurular</a></li>
				<li><a href="yillik-takvim.php">yýllýk takvim</a></li>
				<li><a href="havsak-uyelik.php">hasvak üyelik</a></li>
				<li><a href="iletisim.php">iletiþim</a></li>
			</ul>
		</div>
		<div id="foot">
