...
<?
	...
	if ($sayac < 1)

		{
			...
			echo "Veri Tabanımızda Kayıtlı Üye Ziyaretleri Bulunmamaktadır..."
     ...
     <td width="644" height="17">
       ...
       <table width="668" border="0" align="center" cellpadding="1" cellspacing="1">
         ...
         <tr>
           ...
           <td height="20" colspan="5" align="center" bgcolor="#999999" class="baslikbeyaz">ÜYE ZİYARETLERİ LİSTESİ</td>
...
?>
         ...
         <tr>
           ...
           <td width="31" align="center" class="baslikgri12px"> <a href="?page=uye_ziyaretleri_goruntule&islem=goster&id=<?=$satir["id"];?>  "><img src="images/edit.png" width="16" height="16" border="0" title="<?=$satir["baslik"];?> Başlıklı kaydı değiştir."></a></td>
