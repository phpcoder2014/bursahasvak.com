...
<? 
	...
	if ($gelenid != "" and !ctype_digit($gelenid))
...

		{
			...
			$strmsg3 = "Tüzük İçeriği Güncellendi.";

			$strmsg4 = "Güncelleme sırasında hata oluştu... Girilen bilgiler kaydedilemedi. !";

			$strmsg5 = "Tüzük İçeriği Silindi";

			$strmsg6 = "Silme sırasında hata oluştu... Tüzük İçeriği Silinemedi !";
...

				{
				    ...
				    if (strpos($tmpaciklama, $aranacak) !== false)
						...
						{ 
							...
							echo "<script>self.location = \"index.php?page=tuzuk_goruntule&islem=goster&mesaj=".$strmsg1."&id=".$_POST["id"]."\"</script>";
...

						{
							...
							if($aciklama=="")

								{
									...
									echo "<script>self.location = \"index.php?page=tuzuk_goruntule&islem=goster&mesaj=".$strmsg2."&id=".$_POST["id"]."\"</script>";

								}



							$sql_cumlesi = "update tuzuk set aciklama='".$aciklama."' where id='1'";
									...
									if ($query_sonucu==true)

										{
											...
											echo "<script>self.location = \"index.php?page=tuzuk_goruntule&islem=goster&mesaj=".$strmsg3."\"</script>";
...

										{
											...
											echo "<script>self.location = \"index.php?page=tuzuk_goruntule&islem=goster&mesaj=".$strmsg4."\"</script>";	
...
<form action="index.php?page=tuzuk_goruntule&islem=kaydet" method="post" enctype="multipart/form-data" name="frmBuikadUyelikgoruntule">
  ...
  <tr>
    ...
    <td width="643" height="340" valign="top"><table width="645" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="3" align="center" bgcolor="#999999" class="baslikbeyaz">TÜZÜK DÜZENLE</td>
      ...
      <tr>
        ...
        <td width="116" valign="top" class="basliksiyahkalin">Tüzük İçeriği</td>
