...
<?
	...
	$count = mysql_num_rows(mysql_query("select * from sol3_reklam order by id asc", $veriyolu));
	...
	$sql_cumlesi="select * from sol3_reklam order by id asc LIMIT ".((intval($page)*25)-25).", $perpage";
	...
	if ($sayac < 1)

		{
			...
			echo "Veri Tabanımızda Kayıtlı Sol Alan 3 Reklam Bulunmamaktadır..."
     ...
     <td width="644" height="17">
       ...
       <table width="668" border="0" align="center" cellpadding="1" cellspacing="1">
         ...
         <tr>
           ...
           <td height="20" colspan="4" align="center" bgcolor="#999999" class="baslikbeyaz">SOL ALAN 3 REKLAM LİSTESİ</td>
...
?>
         ...
         <tr>
           ...
           <td align="center" class="baslikgri12px"> <a href="?page=sol3_reklam_goruntule&islem=goster&id=<?=$satir["id"];?>  "><img src="images/edit.png" width="16" height="16" border="0" title="http://<?=$satir["baslik"];?> URL li kaydı değiştir."></a></td>
