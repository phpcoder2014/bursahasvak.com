  ...
  <tr>
    ...
    <td width="857"><table width="771" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="5" align="center" bgcolor="#999999" class="baslikbeyaz">DENETİM FAALİYET RAPORU  D&Uuml;ZENLE</td>
      ...
      <tr>
        ...
        <td height="20" colspan="5" align="center" <? if($_GET["mesaj"]<>""){?> bgcolor="#FF0000" <? }?>class="baslik_beyaz_14"><?=$_GET["mesaj"];?></td>
      ...
      <tr>
        ...
        <td width="306" height="25"><input name="baslik" type="text" id="baslik" size="46" value="<?=$kayit_satiri["baslik"];?>" /></td>

        <td width="152" rowspan="3"><? if($kayit_satiri["resim"]<>""){?>

          <img src="../pdf/<?=$kayit_satiri["resim"];?>" width="155" />

          <? }?></td>

        <td width="153" rowspan="3"><? if($kayit_satiri["pdf"]!==""){echo '&nbsp;&nbsp;<a target="_blank" href="../pdf/'.$kayit_satiri["pdf"].'"><img src="pdf.png" border="0" width="75"></a>';}?></td>
      ...
      <tr>
        ...
        <td><input name="resim" type="file" id="resim" size="46" /><input name="eski_resim" value="<?=$kayit_satiri["resim"];?>" type="hidden" />          </td>
      ...
      <tr>
        ...
        <td><input name="pdf" type="file" id="pdf" size="46" /><input name="eski_pdf" value="<?=$kayit_satiri["pdf"];?>" type="hidden" />          </td>
      ...
      <tr>
        ...
        <td colspan="5" align="center"><input type="submit" name="button" id="button" value="Kaydet">
