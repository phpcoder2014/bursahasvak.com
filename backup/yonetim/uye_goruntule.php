...

		{
...

				{
				    ...
				    if (strpos($tmpaciklama, $aranacak) !== false)
						...
						{ 
							...
							echo "<script>self.location = \"index.php?page=uye_goruntule&islem=goster&mesaj=".$strmsg1."&id=".$_POST["id"]."\"</script>";
...

						{
							...
							if($aciklama=="")

								{
									...
									echo "<script>self.location = \"index.php?page=uye_goruntule&islem=goster&mesaj=".$strmsg2."&id=".$_POST["id"]."\"</script>";

								}



							$sql_cumlesi = "update tbl_uyeListe set aciklama='".$aciklama."' where id='1'";
									...
									if ($query_sonucu==true)

										{
											...
											echo "<script>self.location = \"index.php?page=uye_goruntule&islem=goster&mesaj=".$strmsg3."\"</script>";
...

										{
											...
											echo "<script>self.location = \"index.php?page=uye_goruntule&islem=goster&mesaj=".$strmsg4."\"</script>";	
			...
			elseif($_GET["islem"]=="goster")

					{
						...
						$uye_tablosu = @mysql_query("select * from tbl_uyeListe where id='1'",$veriyolu);

						$kayit_satiri = @mysql_fetch_array($uye_tablosu);

?>



<form action="index.php?page=uye_goruntule&islem=kaydet" method="post" enctype="multipart/form-data" name="frmBuikadUyelikgoruntule">
  ...
  <tr>
    ...
    <td width="643" height="340" valign="top"><table width="645" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="3" align="center" bgcolor="#999999" class="baslikbeyaz">ÜYE LİSTE DÜZENLEME</td>
      ...
      <tr>
        ...
        <td width="116" valign="top" class="basliksiyahkalin">Üye Listeleme İçeriği</td>
