...

		{
...

												{
													...
													if ( strtolower($yuklenen_dosya_uzantisi) == strtolower("jpg") || strtolower($yuklenen_dosya_uzantisi) == strtolower("png") || strtolower($yuklenen_dosya_uzantisi) == strtolower("gif") )
...

														{
															...
															echo "<script>self.location = \"index.php?page=sol3_reklam_goruntule&islem=goster&mesaj=Yüklemek istediğiniz dosya ".$uzanti." uzantılı olduğu için yükleme yapılamaz.\"</script>";	
			...
			elseif($_GET["islem"]=="degistir1")

					{
						...
						echo "<script>self.location = \"index.php?page=sol3_reklam_goruntule&islem=goster&mesaj=Swf Dosya Silinmiştir...\"</script>";
			...
			elseif($_GET["islem"]=="degistir2")

					{
						...
						echo "<script>self.location = \"index.php?page=sol3_reklam_goruntule&islem=goster&mesaj=Script Silinmiştir...\"</script>";
