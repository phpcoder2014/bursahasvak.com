...
$resim=$_GET["resim"];
	...
	if($resim=="sil"){
		...
		$silme_sonucu= mysql_query("delete from uye_ziyaretleriresmi where id=".$_GET["id"],$veriyolu);

		

		echo "<script>self.location = \"index.php?page=uye_ziyaretleri_goruntule&islem=goster&mesaj=Resim Silindi.&id=".$_GET["urunid"]."\"</script>";
...

		{
...

				{
				    ...
				    if (strpos($tmpbaslik, $aranacak) !== false || strpos($tmpaciklama, $aranacak) !== false)
						...
						{ 
							...
							echo "<script>self.location = \"index.php?page=uye_ziyaretleri_goruntule&islem=goster&mesaj=".$strmsg1."&id=".$_POST["id"]."\"</script>";
...

						{
							...
							if($baslik=="")

								{
									...
									echo "<script>self.location = \"index.php?page=uye_ziyaretleri_goruntule&islem=goster&mesaj=".$strmsg2."&id=".$_POST["id"]."\"</script>";
							...
							$sql_cumlesi = "update uye_ziyaretleri set baslik='".$baslik."', aciklama='".$aciklama."', tarih = '".$degistirilen_tarih."' where id=".$_POST["id"];
...

												{
													...
													if (resimuzantikontrolu($yuklenen_resim_uzantisi) == true)

														{
															...
															if ($eski_resim <> "")

																{
																	...
																	unlink("../images/uye_ziyaretleri/buyuk/".$_POST["eski_resim"]);

																	unlink("../images/uye_ziyaretleri/kucuk/".$_POST["eski_resim"]);

																}

															$vtresimadi = $kayid.$iconadi;

															$vte=mysql_query("UPDATE uye_ziyaretleri SET resim='".$vtresimadi."' WHERE id='".$_POST["id"]."'",$veriyolu);																				
...

														{
															...
															echo "<script>self.location = \"index.php?page=uye_ziyaretleri_goruntule&mesaj=Yüklemek istediğiniz resim ".$yuklenen_resim_uzantisi." olduğu için yükleme yapılamaz.\"</script>";	
...

									{
										...
										if (resimuzantikontrolu($yuklenen_resim_uzantisi) == true)

											{
												...
												$resimekle="insert into uye_ziyaretleriresmi (resim,ziyaretid)values ('".$vtresimadi."','".$_POST["id"]."')";
											...
											echo "<script>self.location = \"index.php?page=uye_ziyaretleri_listele&mesaj=".$strmsg3."\"</script>";
...

										{
											...
											echo "<script>self.location = \"index.php?page=uye_ziyaretleri_listele&mesaj=".$strmsg4."\"</script>";	
			...
			elseif($_GET["islem"]=="sil")

					{
						...
						$sql= @mysql_query("select * from uye_ziyaretleri where id=".$gelenid,$veriyolu);
						...
						$silme_sonucu= mysql_query("delete from uye_ziyaretleri where id=".$gelenid,$veriyolu);
						...
						if ($silme_sonucu==true)

							{
								...
								if ($eski_resim != "")

									{
										...
										unlink("../images/uye_ziyaretleri/buyuk/".$eski_resim);

										unlink("../images/uye_ziyaretleri/kucuk/".$eski_resim);

									}								

								echo "<script>self.location = \"index.php?page=uye_ziyaretleri_listele&mesaj=".$strmsg5."\"</script>";
...

							{
								...
								echo "<script>self.location = \"index.php?page=uye_ziyaretleri_listele&mesaj=".$strmsg6."\"</script>";
			...
			elseif($_GET["islem"]=="goster")

					{
						...
						$etkinlik_tablosu = @mysql_query("select * from uye_ziyaretleri where id=".$gelenid,$veriyolu);
...
<form action="index.php?page=uye_ziyaretleri_goruntule&islem=kaydet" method="post" enctype="multipart/form-data" name="frmduyurugoruntule">

<input name="id" type="hidden" value="<?=$gelenid ?>">

<?

	$etkinlik_tablosu = @mysql_query("select * from uye_ziyaretleri where id=".$_GET["id"],$veriyolu);
  ...
  <tr>
    ...
    <td width="643" height="340"><table width="645" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="4" align="center" bgcolor="#999999" class="baslikbeyaz">ÜYE ZİYARETLERİ D&Uuml;ZENLE</td>
      ...
      <tr>
        ...
        <td class="basliksiyahkalin">Ziyaret Başlığı</td>
...
?></td>
      ...
      <tr>
        ...
        <td rowspan="11" valign="top"><? if($kayit_satiri['resim']!==""){echo '&nbsp;&nbsp;<a target="_blank" href="../images/uye_ziyaretleri/buyuk/'.$kayit_satiri['resim'].'"><img src="../images/uye_ziyaretleri/buyuk/'.$kayit_satiri['resim'].'" width="100" border="0"></a>';}?></td>
      ...
      <tr>
        ...
        <td colspan="4"><table width="119" border="0" cellspacing="2" cellpadding="1">
					  ...
					  <?
						...
						$urn=mysql_query("SELECT * FROM uye_ziyaretleriresmi WHERE ziyaretid='".$gelenid."' ORDER BY id ASC",$veriyolu);
						...
						while($urunler1=mysql_fetch_array($urn)){
						 ...
						 ?>
							 ...
							 <table width="50" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
									...
									$resim="../images/uye_ziyaretleri/buyuk/".$urunler1["resim"];
							  ...
							  <table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
								  ...
								  <td width="50" colspan="3" align="center" valign="top" onMouseOver="class=urun_adi_yesil" onMouseOut="urun_adi_gri">
									...
									<img src="../images/uye_ziyaretleri/kucuk/<?=$urunler1["resim"]; ?>" width="50"   border="2" vspace="5" hspace="5" align="center" style="border-color:#cccccc;" /><br />

								  <a href="?page=uye_ziyaretleri_goruntule&resim=sil&id=<?=$urunler1["id"];?>&urunid=<?=$_GET["id"]?>" class="hatamesaji">[ Sil ]</a> </td>
