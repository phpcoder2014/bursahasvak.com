...
<? 
	...
	if ($gelenid != "" and !ctype_digit($gelenid))
...

		{
			...
			$strmsg3 = "Basında Biz İçeriği Güncellendi.";
  ...
  <tr>
    ...
    <td width="643" height="340" valign="top"><table width="645" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="3" align="center" bgcolor="#999999" class="baslikbeyaz">Basında Biz D&Uuml;ZENLE</td>
      ...
      <tr>
        ...
        <td width="116" valign="top" class="basliksiyahkalin">Basında Biz İçeriği</td>
