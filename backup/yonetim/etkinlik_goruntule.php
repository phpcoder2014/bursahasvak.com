							...
							$sql_cumlesi = "update etkinlikler set baslik='".$baslik."', aciklama='".$aciklama."', tarih = '".$degistirilen_tarih."' where id=".$_POST["id"];
									...
									if ($query_sonucu==true)

										{
											...
											echo "<script>self.location = \"index.php?page=etkinlik_goruntule&islem=goster&id=".$_POST["id"]."&mesaj=Yüklemek istediğiniz dosyanın boyutu çok fazla. Kayıt yapıldı resmi yeniden yükleyin\"</script>";	
													...
													if (resimuzantikontrolu($yuklenen_resim_uzantisi) == true)
...

														{
															...
															echo "<script>self.location = \"index.php?page=etkinlik_goruntule&mesaj=Yüklemek istediğiniz resim ".$yuklenen_resim_uzantisi." olduğu için yükleme yapılamaz.\"</script>";	
								...
								if($_FILES["resim".$i]["size"] > 1333630){
										...
										echo "<script>self.location = \"index.php?page=etkinlik_goruntule&islem=goster&id=".$_POST['id']."&mesaj=".$resimname." dosyanın boyutu çok fazla. Kayıt yapıldı resmi yeniden yükleyin\"</script>";	
  ...
  <tr>
    ...
    <td width="643" height="340"><table width="645" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <td height="20" colspan="4" align="center" bgcolor="#999999" class="baslikbeyaz">ETKİNLİK D&Uuml;ZENLE</td>
      ...
      <tr>
        ...
        <td class="basliksiyahkalin">Etkinlik Başlığı</td>
