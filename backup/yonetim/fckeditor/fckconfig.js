...
FCKConfig.ToolbarSets["Default"] = [
	['Source','Templates'],
     ['Image','Flash','Table','SpecialChar','TextColor','BGColor'],
	['Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck','-','OrderedList','UnorderedList','Blockquote','CreateDiv','-','Link','Unlink','Anchor'],
	'/',
