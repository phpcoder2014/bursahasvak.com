		...
		{	
		    ...
		    if (strpos($tmpbaslik, $aranacak) !== false || strpos($tmpkisaaciklama, $aranacak) !== false || strpos($tmpaciklama, $aranacak) !== false || strpos($tmpbasliken, $aranacak) !== false || strpos($tmpkisaaciklamaen, $aranacak) !== false || strpos($tmpaciklamaen, $aranacak) !== false)
			...
			else
				{
					...
					$sql_cümlesi = "insert into duyurular (baslik, kisaaciklama, aciklama, basliken, kisaaciklamaen, aciklamaen, tarih,yeni) values ('".$baslik."','".$kisaaciklama."','".$aciklama."','".$basliken."','".$kisaaciklamaen."','".$aciklamaen."','".$kayit_edilecek_tarih."','".$yeni."')";
								...
								if ($_FILES["resim"]["name"])
									{
										...
										if (resimuzantikontrolu($yuklenen_resim_uzantisi) == true)
											...
											{
												echo "<script>self.location = \"index.php?page=duyuru_ekle&mesaj=Yüklemek istediğiniz resim ".$uzanti." olduğu için yükleme yapılamaz.\"</script>";	
											}
									}
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="381" valign="top"><table width="671" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr>
          <td height="13" align="left" class="basliksiyahkalin">Duyuru Başlığı (Tr)</td>
          <td align="left" class="basliksiyahkalin">:</td>
          <td height="10" align="left"><input name="baslik" type="text" size="46"/></td>
        </tr>
        <tr>
          <td height="13" align="left" class="basliksiyahkalin">Duyuru Başlığı (En)</td>
          <td align="left" class="basliksiyahkalin">:</td>
