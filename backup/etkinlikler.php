	...
	<body>
		<div id="container">
			...
			<div id="Pagecenter">
					...
					<div class="aboutText">
						<?php
								$sql_cumlesi="select id, resim, aciklama, baslik from etkinlikler order by tarih desc limit 0,15";
						...
						<div class="uyeImg block">		
							<div class="zoom pink">
			                <a href="etkinliklerDetay.php?id=<?php echo $kayitlarYaz["id"]; ?>"><img src="yonetim/images/etkinlikler/buyuk/<?php echo $kayitlarYaz["resim"] ?>" alt="etkinlik adı" width="180" height="255" /></a>
			                </div>
