...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="css/etkinlikler-icerik.css" rel="stylesheet" type="text/css" />
	</head>
		...
		<div id="container">
			...
			<div id="content">
				<ul class="navMenu">
					...
					<li class="navActive"><a href="">Zirveden Gelen Topuk Sesleri</a></li>
				</ul>
				<?php 
					include("etkinlikler-icerikMain.php");
				?>
				<div id="right">
					<div class="search">
