...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="description" content="TÃ¼rkiye Devlet Hastaneleri ve Hastalara YardÄ±m VakfÄ± HASVAK Bursa Åžubesi" />
		...
		<div id="container">
			...
			<div id="content">
				<ul class="navMenu">
					...
					<li class="navActive"><a href="">Basında Biz</a></li>
				</ul>
<div id="Pagecenter">
					<div class="topImg">
						<span>Etkinlik Detay</span>
						<img src="images/duyurular.png" width="850" height="200" alt="Etkinlikler" />
					</div>
					<div class="aboutText">
						<?php
						mysql_query("SET CHARACTER SET utf8");						
						$tuzuk_tablosu = @mysql_query("select * from etkinlik_takvimi where id='".$_GET['id']."'",$veriyolu);
						$kayit_satiri = @mysql_fetch_array($tuzuk_tablosu);
						?>
                        <h2><?php echo $kayit_satiri["baslik"]?></h2>
						<span><?php echo $kayit_satiri["icerik"]?></span>
					</div>
			  </div>
				<div id="right">
					<div class="search">
			...
			<ul class="menu">
				...
				<li><a href="etkinlikler.php">etkinlikler</a></li>
				<li><a href="duyurular.php">duyurular</a></li>
				<li><a class="active" href="basinda-biz.php">basında biz</a></li>
				<li><a href="hasvak-uyelik.php">hasvak üyelik</a></li>
				<li><a href="iletisim.php">iletişim</a></li>
			</ul>
		</div>
